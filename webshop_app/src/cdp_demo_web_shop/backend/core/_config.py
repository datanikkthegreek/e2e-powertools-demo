...
class AppConfig(BaseSettings):
    ...
    zerobus_catalog: str = Field(default="serverless_sandbox_avaa82_catalog")
    zerobus_schema: str = Field(default="cdp")
    ...
    # --- Databricks job that runs the cdp-triggered pipeline ---
    # The Analytics page resolves this job by name and triggers it via run_now.
    triggered_job_name: str = Field(default="cdp-batch-gtm")
