"""Shared constants, JSON schema, and helpers for the CDP silver pipeline.
...
TABLE_CATALOG = spark.conf.get("cdp.table_catalog")
TABLE_SCHEMA = spark.conf.get("cdp.table_schema")


def table_name(name: str) -> str:
    """Return a fully-qualified table name in the configured CDP namespace."""
