...
#   CATALOG=... SCHEMA=... PROFILE=... scripts/upload_pdfs.sh
#   scripts/upload_pdfs.sh <profile> <catalog> <schema> <manuals_volume> <datasheets_volume>
set -euo pipefail
...
# Guardrail: this demo only ever touches techsummit, never cdp.
